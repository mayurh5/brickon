<script type="text/javascript">
    window.onload = function() {
        ...
        CertificateForm.initEvents = function() {
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row) {
                            ...
                            html +=
                                ...
                                row.id +
                                '" class="custom-control-input certificate-active-status" id="icon-animation-switch_' +
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row) {
                            ...
                            html += ' <a href="' + baseUrl + 'certifiactes/create/' + row.id +
            ...
            $('body').on('change', '.certificate-active-status', function() {
                ...
                window.getResponseInJsonFromURL(baseUrl + 'certifiactes/status/update', formData, (
                    ...
                    }, CertificateForm.processExceptions, 'POST');
