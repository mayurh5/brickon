<script>
    ...
    function primary(params) {
        ...
        if (params === 1) {
            ...
            html +=
                "<span class='badge badge-primary font-small-1' style='padding: 0.25rem 0.45rem;'>PRIMARY</span>";

        } else  {

            html +=
                "<span class='badge badge-warning font-small-1 ' style='padding: 0.25rem 0.45rem;'>BASIC</span>";
