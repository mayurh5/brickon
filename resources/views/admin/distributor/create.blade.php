...
{{-- page title --}}
@section('title','Distributor Create')
    ...
    <div class="card">
        ...
        <p>
            <ol class="breadcrumb p-0 mb-0 pl-1 bg-white mt-0">
                ...
                <li class="breadcrumb-item active">{{ trans('pages.add_with_attr', ['attribute' => 'Distributor']) }}</li>
            </ol>
        </p>

        <div class="card-header pt-75">
            <h4 class="card-title text-primary">{{ trans('pages.add_with_attr', ['attribute' => 'Distributor']) }}</h4>
        </div>
                                    ...
                                    <div class="row mr-25">
                                        ...
                                        <div class="col-md-12 form-group">
                                          <div class="controls">
                                              ...
                                              <textarea name="address" id="" class="form-control" cols="2" rows="2"></textarea>
                                          </div>
                                      </div>
                                    </div>
                                </div>
